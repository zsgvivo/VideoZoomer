bash /opt/tiger/aiic_verl/scripts/free_gpumem.sh
export VLLM_USE_V1=1
python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files="/mnt/bn/tiktok-mm-4/aiic/users/dingyang/data/yamls/mv_math_rl_train.yaml" \
    data.val_files="/mnt/bn/tiktok-mm-5/aiic/users/dingyang/data/Video-MMLU/reasoning_qa.json" \
    ...
    actor_rollout_ref.rollout.tool_call=video_zoom \
    actor_rollout_ref.rollout.gpu_memory_utilization=0.7 \
    actor_rollout_ref.rollout.data_max_pixels=100352 \
    actor_rollout_ref.rollout.data_min_pixels=25088 \
    ...
    trainer.project_name='dingyang_verl_grpo_video_eval_debug' \
    trainer.experiment_name='qwen2_5_vl_7b_videlmmlu_maxframe128_fps0.5_maxpixel100352_toolcall_rnd5_sftv6_60_rule' \
    ...
    trainer.tool_call_generations_to_log_to_wandb=100 \
    ...
    trainer.save_mem=True \
    'trainer.validation_data_dir=/mnt/hdfs/yangding2/logs/${trainer.project_name}/${trainer.experiment_name}/val'