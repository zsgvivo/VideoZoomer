...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="/mnt/bn/tiktok-mm-5/aiic/users/dingyang/data/longvideo-reason/train_processed_filtered.json" \
    data.val_files="/mnt/bn/tiktok-mm-4/aiic/users/dingyang/data/yamls/lvreason_mlvu_val.yaml" \
    ...
    actor_rollout_ref.model.path="/mnt/hdfs/yangding/checkpoints/SFT/qwen2_5vl-7b_video_tool_call_coldstart_sftv6reflection_epoch1_lr5e-6" \
    ...
    trainer.experiment_name='qwen2_5_vl_7b_lvreason_n16_0.1formatv2_penalty0.5tgt0.5_sftv6reflection_fps0.5_maxround5' \
    ...
    'trainer.rollout_data_dir=/mnt/hdfs/yangding2/logs/${trainer.project_name}/${trainer.experiment_name}/train' \
    ...
    reward_model.target_tool_call_rate=0.5 \
    ...
    'trainer.default_local_dir=/mnt/hdfs/yangding2/checkpoints/${trainer.project_name}/${trainer.experiment_name}'