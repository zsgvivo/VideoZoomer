...
from verl.utils.reward_score.openr1 import acc_reward
def custom_metric(predictions: list[str], formatted_doc: Doc, **kwargs) -> bool:
    predict_str = predictions[0]
    sol = formatted_doc.choices[formatted_doc.gold_index]
    return acc_reward(predict_str, sol)
...
extend_enum(Metrics, "metric_name", my_custom_metric)
...
aime24 = LightevalTaskConfig(
    ...
    metric=[expr_gold_metric, my_custom_metric],
    version=1,
)
...
math_500 = LightevalTaskConfig(
    ...
    few_shots_select=None,
    generation_size=32768,
    metric=[latex_gold_metric, my_custom_metric],
    version=1,
)
...
amc = LightevalTaskConfig(
    name="amc",
    suite=["custom"],
    prompt_function=amc_prompt_fn,
    hf_repo="AI-MO/aimo-validation-amc",
    hf_subset="default",
    hf_avail_splits=["train"],
    evaluation_splits=["train"],
    few_shots_split=None,
