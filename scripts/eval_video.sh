python3 -m verl.trainer.main_ppo \
    ...
    data.val_files="/mnt/bn/tiktok-mm-5/aiic/users/dingyang/data/Video-MME/videomme/test_processed.json" \
    ...
    actor_rollout_ref.rollout.tool_call_max_frames=60 \
    ...
    trainer.project_name='dingyang_verl_grpo_video_eval' \
    trainer.experiment_name='qwen2_5_vl_7b_tollcall_mvbench_maxframe120_fps1.0_maxpixel100352' \
    ...
    'actor_rollout_ref.rollout.limit_mm_per_prompt={'image': 120}' \
    ...
    'trainer.validation_data_dir=/mnt/bn/tiktok-mm-5/aiic/users/dingyang/logs/${trainer.project_name}/${trainer.experiment_name}/val'