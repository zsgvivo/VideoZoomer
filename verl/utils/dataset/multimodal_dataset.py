...
if __name__ == '__main__':
    ...
    train_dataset = MultiModalDataset(
        data_path='data/longvideo-reason/train_processed_filtered.json',
        tokenizer=tokenizer,
        processor=processor,
        prompt_key='prompt',
        image_key='videos',
    ...
    cache_path = f'data/preprocessed_frames/fps{train_dataset.video_fps}_upbound{train_dataset.frames_upbound}_maxpixels{train_dataset.max_pixels}_minpixels{train_dataset.min_pixels}'
    data = json.load(open('data/longvideo-reason/test_processed.json'))
